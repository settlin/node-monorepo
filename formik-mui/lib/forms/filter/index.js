...
var Input = function Input(props) {
  return _react.default.createElement(_reactSelect.components.Input, _extends({}, props, {
    autoComplete: "none"
  }));
};
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      if (optionsAsync) {
        ...
        return _react.default.createElement(AsyncSelect, _extends({
      ...
      var SyncSelect = creatable ? require('react-select/lib/Creatable').default : _reactSelect.default;
      return _react.default.createElement(SyncSelect, _extends({
        options: options || []
      }, commonProps));
    }
  }]);
