...
var _filter = _interopRequireDefault(require("../forms/filter"));
  ...
  _createClass(UserPhoneOtp, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Grid.default, {
        ...
        item: true,
        xs: 12
      }, verified ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_TextField.default, _extends({}, props, {
        type: "number",
        inputProps: {
          readOnly: true
        },
        InputProps: {
          endAdornment: _react.default.createElement(_InputAdornment.default, null, _react.default.createElement(_Icon.default, {
            classes: {
              root: classes.doneAll
            },
            "aria-label": "Verified"
          }, _react.default.createElement(_DoneAll.default, null)))
        }
      })), (user || {})._id && _react.default.createElement(_Input.default, {
        value: user._id,
        name: "userId",
        label: "",
        type: "hidden"
        ...
        InputProps: {
          endAdornment: _react.default.createElement(_InputAdornment.default, null, _react.default.createElement(_IconButton.default, {
            "aria-label": "Cancel Otp",
            onClick: hCancelOtp
          }, _react.default.createElement(_Clear.default, null)))
        }
      }) : phones.length ? _react.default.createElement(_filter.default, _extends({}, props, {
        defaultValue: phones[0].value,
        options: phones
      })) : _react.default.createElement(_TextField.default, _extends({}, props, {
        type: "number",
        onKeyDown: hEnterOnMobile
      }))), !verified && _react.default.createElement(_Grid.default, {
        container: true,
        item: true,
        xs: 12,
        justify: sent ? 'space-between' : 'flex-end'
      }, sent ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(ResendButton, {
        tick: tick,
      ...
      }, "Verify ", mobile)) : _react.default.createElement(_Button.default, {
        size: "small",
        variant: "outlined",
        color: "primary",
        onClick: hSend,
...
var _default = (0, _styles.withStyles)(styles)(UserPhoneOtp);
