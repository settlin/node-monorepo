...
function (_React$Component) {
  ...
  function Persist(props) {
    ...
    _this.saveForm = (0, _lodash.default)(_this.saveForm, props.debounce).bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Persist, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (!(0, _reactFastCompare.default)((prevProps.formik || {}).values, (this.context.formik || {}).values)) this.saveForm(prevProps.formik.values);
    }
  }, {
...
var _default = (0, _formik.connect)(Persist);
