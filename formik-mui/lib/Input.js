...
var Input = function Input(_ref) {
  ...
  if (typeof validateOrig === 'function') validateFunc = validateOrig; // original validate function
      ...
      switch (typeOrig) {
        ...
        case 'dob':
          validateFunc = function validateFunc(v) {
            return !(0, _dob.default)(v) && (typeof validateOrig === 'string' ? validateOrig : 'Invalid DOB Age Limit (18 to 57)');
          };
        ...
        case 'otp':
          validateFunc = function validateFunc(v) {
            return (0, _mobile.default)(v, typeof validateOrig === 'string' ? validateOrig : 'Invalid Indian Mobile');
          };
        ...
        case 'email':
          validateFunc = function validateFunc(v) {
            return (0, _email.default)(v, typeof validateOrig === 'string' ? validateOrig : 'Invalid Email');
          };
  ...
  return _react.default.createElement(Grid, _extends({
    item: true
  }, container), _react.default.createElement(Field, _extends({
    validate: validate,
    label: label,
    type: type,
    compact: true
